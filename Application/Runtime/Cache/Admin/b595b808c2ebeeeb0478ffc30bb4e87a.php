			...
			<div class="am-cf admin-main">
							...
							<li>
								<a href="admin-index.html"><span class="am-icon-home"> 首页</span>
									<li class="admin-parent">
										<a class="am-cf" ><span class="am-icon-file"></span>首页管理<span class="am-icon-angle-right am-fr am-margin-right"></span> </a>
										<ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
											<li>
												<input type="hidden" id="lie2" name="lie2" value="<?php echo ($lie2); ?>">
												<a  href="<?php echo U('Index/order');?>" target="right" class="am-cf"><span class="am-icon-check"></span> 商品列表管理
													<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span>
												</a>
											</li>
											<li>
												<a  href="/ersh/Public/oa/user.html" target="right" class="am-cf"><span class="am-icon-check"></span> 用户管理
													<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span>
												</a>
											</li>
										</ul>
									...
									<li class="admin-parent">
										...
										<ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
											<li>
												<a  href="/ersh/Public/oa/depart.html" target="right" class="am-cf"><span class="am-icon-check"></span> 部门管理
													<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span>
												</a>
											</li>
											<li>
									...
									<li class="admin-parent">
										<a class="am-cf"><span class="am-icon-file"></span> 日程管理<span class="am-icon-angle-right am-fr am-margin-right"></span> </a>
										<ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
													<li>
														<a  href="/ersh/Public/oa/schedule.html" target="right" class="am-cf"><span class="am-icon-check"></span> 我的日程
															<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span>
														</a>
													</li>
									...
									<li class="admin-parent">
										...
										<ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
													<li>
														<a  href="/ersh/Public/oa/role.html" target="right" class="am-cf"><span class="am-icon-check"></span> 角色管理
															<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span>
														</a>
													</li>
									...
									<li>
										<a href="account/logOut.action"><span class="am-icon-sign-out"></span> 注销</a>
									</li>
						</ul>
				...
				<div class="admin-content">
					<div class="admin-content-body">
						<iframe src="/ersh/Public/oa/order.html" width="100%" height="1100" name="right" style="border: none;"></iframe>
					</div>
				</div>
...
<![endif]-->
			...
			<!--<![endif]-->
			<script src="/ersh/Public/oa/js/amazeui.min.js"></script>
			<script src="/ersh/Public/oa/js/app.js"></script>
			...
			<script type="text/javascript">
				...
				function updatePwd(title, id) {
					$.jq_Panel({
						...
						iframeWidth: 500,
						iframeHeight: 300,
						url: "/ersh/Public/oa/updatePwd.html"
					});
				}
				$(function(){
				    var lie2 = $('#lie2').val();
